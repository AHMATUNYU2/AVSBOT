...
github : AHMATUNYU2 
YouTube : ahmatunyu2 
Website : https://Ahmat unyu2.my.id
...
menu = `
┏━━⬣ 𝙄𝙉𝙁𝙊
┃⬡ Nama User : ${ahmatunyu2.getName(m.sender)}
┃⬡ Nama Bot : ${Ahmatunyu2.user.name}
┃⬡ Prefix : 「 ${prefix} 」
...
┃⬡ Runtime : ${runtime()}
┃⬡ Battery : ${ahmatunyu2.battery ? ahmatunyu2.battery.value +'%' : 'Belum kedetect'} ${Ahmatunyu2.battery ? AHMATUNYU2.battery.live ? '🔌 Charging...' : '⚡ Discharging' : ''}
┃⬡ Source code :github.com/AHMATUNYU2 
┗━━⬣
...
┃ ⬡ ${prefix}attp2
┃ ⬡ ${prefix}attp3
┗━━「 ${ahmatunyu2.user.name.toUpperCase()} 」━━
